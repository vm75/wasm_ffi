...
(function dartProgram() {
  ...
  var A = {JS_CONST: function JS_CONST() {
    ...
    DynamicLibrary_open(type, moduleName) {
      var $async$goto = 0,
        $async$completer = A._makeAsyncAwaitCompleter(type$.DynamicLibrary),
        $async$returnValue, module, t1, memory;
      var $async$DynamicLibrary_open = A._wrapJsFunctionForAsync(function($async$errorCode, $async$result) {
        ...
        while (true)
          switch ($async$goto) {
            case 0:
              // Function start
              A.Memory_init();
              $async$goto = type === B.WasmType_1 ? 3 : 5;
              break;
            case 3:
              // then
              $async$goto = 6;
              return A._asyncAwait(A.EmscriptenModule_compile(moduleName, null), $async$DynamicLibrary_open);
            case 6:
            ...
            case 5:
              // else
              t1 = A.ArgumentError$("You need to provide a wasmBinary when loading a standalone module!", null);
              throw A.wrapException(t1);
            case 4:
              // join
              memory = A.Memory$_(module);
              switch (B.GlobalMemory_2) {
                case B.GlobalMemory_0:
                  $.Memory_global = memory;
                  break;
                case B.GlobalMemory_1:
                  break;
                case B.GlobalMemory_2:
                  if ($.Memory_global == null)
                    $.Memory_global = memory;
                  break;
              }
              $async$returnValue = new A.DynamicLibrary(memory);
              // goto return
              $async$goto = 1;
              break;
            case 1:
      ...
      return A._asyncStartSync($async$DynamicLibrary_open, $async$completer);
    },
    WasmType: function WasmType(t0) {
      this._core$_name = t0;
    },
    ...
    Memory_init() {
      if ($.Memory__initalized)
        return;
      $.Memory__initalized = true;
      var t1 = type$.Float;
      $.sizeMap.$indexSet(0, A.createRuntimeType(t1), 4);
      A.registerNativeMarshallerType(t1);
      t1 = type$.Double;
      $.sizeMap.$indexSet(0, A.createRuntimeType(t1), 8);
      A.registerNativeMarshallerType(t1);
      t1 = type$.Int8;
      $.sizeMap.$indexSet(0, A.createRuntimeType(t1), 1);
      A.registerNativeMarshallerType(t1);
      t1 = type$.Uint8;
      $.sizeMap.$indexSet(0, A.createRuntimeType(t1), 1);
      A.registerNativeMarshallerType(t1);
      t1 = type$.Int16;
      $.sizeMap.$indexSet(0, A.createRuntimeType(t1), 2);
      A.registerNativeMarshallerType(t1);
      t1 = type$.Uint16;
      $.sizeMap.$indexSet(0, A.createRuntimeType(t1), 2);
      A.registerNativeMarshallerType(t1);
      ...
      $.sizeMap.$indexSet(0, A.createRuntimeType(t1), 4);
      A.registerNativeMarshallerType(t1);
      A.registerNativeMarshallerType(type$.Void);
      A.registerNativeMarshallerType(type$.NativeFunction_dynamic);
    },
    Memory$_(_module) {
      var t4,
        t1 = _module.get$exports(_module),
        t2 = A._arrayInstanceType(t1),
        t3 = type$.WasmSymbol;
      t2 = A.Map_Map$fromEntries(new A.MappedListIterable(t1, t2._eval$1("MapEntry<int,WasmSymbol>(1)")._as(new A.Memory$__closure()), t2._eval$1("MappedListIterable<1,MapEntry<int,WasmSymbol>>")), type$.int, t3);
      t1 = _module.get$exports(_module);
      t4 = A._arrayInstanceType(t1);
      return new A.Memory(_module, A.Map_Map$fromEntries(new A.MappedListIterable(t1, t4._eval$1("MapEntry<String,WasmSymbol>(1)")._as(new A.Memory$__closure0()), t4._eval$1("MappedListIterable<1,MapEntry<String,WasmSymbol>>")), type$.String, t3), t2);
    },
    symbolByAddress(m, address) {
      var s = m._symbolsByAddress.$index(0, address);
      if (s != null)
        return s;
      else
        throw A.wrapException(A.ArgumentError$("Could not find symbol at " + address + "!", null));
    },
    symbolByName(m, $name) {
      ...
      if (s != null)
        ...
        throw A.wrapException(A.ArgumentError$("Could not find symbol " + $name + "!", null));
    },
    ...
    GlobalMemory: function GlobalMemory(t0) {
      this._core$_name = t0;
    },
    _adu(original, tried) {
      return "CRITICAL EXCEPTION! Address double use! This should never happen, please report this issue on github immediately at https://github.com/vm75/wasm_ffi\r\nOriginal: " + A.S(original) + "\r\nTried: " + tried.toString$0(0);
    },
    _fromWasmFunction($name, func) {
      var index, $length, _null = null,
        _s39_ = " does not seem to be a function symbol!",
        s = A._asStringQ(func.name);
      if (s != null) {
        index = A.Primitives_parseInt(s, _null);
        if (index != null) {
          $length = A._asIntQ(func.length);
          if ($length != null)
            return new A.FunctionDescription($length, func, index, $name);
          else
            throw A.wrapException(A.ArgumentError$($name + _s39_, _null));
        } else
          throw A.wrapException(A.ArgumentError$($name + _s39_, _null));
      } else
        throw A.wrapException(A.ArgumentError$($name + _s39_, _null));
    },
    EmscriptenModule__moduleFunction(moduleName) {
      var moduleFunction = type$.nullable_Function._as(self.globalThis[moduleName]);
      if (moduleFunction != null)
        return moduleFunction;
      else
        throw A.wrapException(A.StateError$("Could not find a emscripten module named " + moduleName));
    },
    EmscriptenModule_compile(moduleName, wasmBinary) {
      var $async$goto = 0,
        $async$completer = A._makeAsyncAwaitCompleter(type$.EmscriptenModule),
        $async$returnValue, moduleFunction, module, o;
      var $async$EmscriptenModule_compile = A._wrapJsFunctionForAsync(function($async$errorCode, $async$result) {
        if ($async$errorCode === 1)
          return A._asyncRethrow($async$result, $async$completer);
        while (true)
          switch ($async$goto) {
            case 0:
              // Function start
              moduleFunction = A.EmscriptenModule__moduleFunction(moduleName);
            ...
            case 3:
              // then
              $async$goto = 6;
              return A._asyncAwait(A.promiseToFuture(o, type$.dynamic), $async$EmscriptenModule_compile);
            case 6:
              // returning from await.
              $async$returnValue = A.EmscriptenModule_EmscriptenModule$_fromJs(module);
              // goto return
              $async$goto = 1;
              break;
              // goto join
            ...
            case 5:
              // else
              throw A.wrapException(A.StateError$("Could not instantiate an emscripten module!"));
            case 4:
              // join
            case 1:
              // return
      ...
      return A._asyncStartSync($async$EmscriptenModule_compile, $async$completer);
    },
    EmscriptenModule_EmscriptenModule$_fromJs(module) {
      var knownAddresses, exports, entries, t2, t3, t4, t5, t6, malloc, free, entry, t7, value, g, description,
        t1 = J.getInterceptor$x(module),
        asm = t1.get$wasmExports(module);
      if (asm == null)
        asm = t1.get$asm(module);
      if (asm != null) {
        knownAddresses = A.LinkedHashMap_LinkedHashMap$_empty(type$.int, type$.WasmSymbol);
        exports = A._setArrayType([], type$.JSArray_WasmSymbol);
        entries = self.Object.entries(asm);
        if (entries != null) {
          for (t1 = J.get$iterator$ax(entries), t2 = type$.Function, t3 = type$.List_dynamic, t4 = type$.Object, t5 = type$.void_Function_int, t6 = type$.int_Function_int, malloc = null, free = null; t1.moveNext$0();) {
            entry = t1.get$current(t1);
            if (t3._is(entry)) {
              t7 = J.getInterceptor$ax(entry);
              value = t7.get$last(entry);
              if (value == null)
                value = t4._as(value);
              if (A._isInt(value)) {
                g = new A.Global(value, A._asString(t7.get$first(entry)));
                if (knownAddresses.containsKey$1(0, value) && !(knownAddresses.$index(0, value) instanceof A.Global))
                  throw A.wrapException(A.StateError$(A._adu(knownAddresses.$index(0, value), g)));
                knownAddresses.$indexSet(0, value, g);
                B.JSArray_methods.add$1(exports, g);
              } else if (t2._is(value)) {
                description = A._fromWasmFunction(A._asString(t7.get$first(entry)), value);
                t7 = description.address;
                if (knownAddresses.containsKey$1(0, t7) && !(knownAddresses.$index(0, t7) instanceof A.FunctionDescription))
                  throw A.wrapException(A.StateError$(A._adu(knownAddresses.$index(0, t7), description)));
                knownAddresses.$indexSet(0, t7, description);
                B.JSArray_methods.add$1(exports, description);
                t7 = description.name;
                if (t7 === "malloc")
                ...
                A._asString(t7.get$first(entry));
            } else
              throw A.wrapException(A.StateError$("Unexpected entry in entries(Module['asm'])!"));
          }
          if (malloc != null)
            if (free != null)
              return new A.EmscriptenModule(module, exports);
            else
              throw A.wrapException(A.StateError$("Module does not export the free function!"));
          else
            throw A.wrapException(A.StateError$("Module does not export the malloc function!"));
        } else
          throw A.wrapException(A.StateError$("JavaScript error: Could not access entries of Module['asm']!"));
      } else
        throw A.wrapException(A.StateError$("Could not access Module['asm'], are your sure your module was compiled using emscripten?"));
    },
    ...
    MarshallingException$(message) {
      return new A.MarshallingException(message);
    },
    MarshallingException$noAddress(o) {
      return new A.MarshallingException("Expected a address (int) but found " + J.get$runtimeType$(o).toString$0(0));
    },
    MarshallingException$typeMissmatch(t, o) {
      return new A.MarshallingException("Expected a type of " + t.toString$0(0) + " but object has type " + J.get$runtimeType$(o).toString$0(0));
    },
    ...
    execute(base, args, memory, $T) {
      var result,
        t1 = A._arrayInstanceType(args),
        t2 = t1._eval$1("Object(1)");
      t1 = t1._eval$1("MappedListIterable<1,Object>");
      if (A.createRuntimeType($T) === $.$get$DartVoidType()) {
        A.Function_apply(base, A.List_List$of(new A.MappedListIterable(args, t2._as(A.marshaller___toJsType$closure()), t1), true, t1._eval$1("ListIterable.E")));
        $T._as(null);
        return null;
      } else {
        result = A.Function_apply(base, A.List_List$of(new A.MappedListIterable(args, t2._as(A.marshaller___toJsType$closure()), t1), true, t1._eval$1("ListIterable.E")));
        return A._toDartType(result == null ? type$.Object._as(result) : result, memory, $T);
      }
    },
    _toJsType(dartObject) {
      type$.Object._as(dartObject);
      if (A._isInt(dartObject) || typeof dartObject == "number" || A._isBool(dartObject))
        return dartObject;
      else if (dartObject instanceof A.Pointer)
        return dartObject.address;
      else
        throw A.wrapException(A.MarshallingException$("Could not convert dart type " + J.get$runtimeType$(dartObject).toString$0(0) + " to a JavaScript type!"));
    },
    _inferFromSignature(signature) {
      var t1, h,
        returnType = J.trim$0$s(B.JSArray_methods.get$last(signature.split("=>")));
      if (B.JSString_methods.startsWith$1(returnType, $.$get$pointerPointerPointerPrefix()))
        throw A.wrapException(B.MarshallingException_CC0);
      t1 = $.$get$_knownTypes();
      h = t1.$index(0, returnType);
      if (h != null)
        return h;
      else if (B.JSString_methods.startsWith$1(returnType, $.$get$pointerNativeFunctionPrefix()))
        throw A.wrapException(B.MarshallingException_VRH);
      else
        throw A.wrapException(A.MarshallingException$("Unknown type " + returnType + " (infered from " + signature + "), all marshallable types: " + A.S(A.List_List$of(t1.get$keys(t1), false, type$.String))));
    },
    registerNativeMarshallerType($T) {
      var t3, _null = null,
        t1 = $.$get$_knownTypes(),
        t2 = $T._eval$1("Pointer<0>");
      t1.$indexSet(0, A._rtiToString(A.createRuntimeType(t2)._rti, _null), new A.InvokeHelper(_null, _null, $T._eval$1("InvokeHelper<Pointer<0>>")));
      t3 = $T._eval$1("Pointer<Pointer<0>>");
      t1.$indexSet(0, A._rtiToString(A.createRuntimeType(t3)._rti, _null), new A.InvokeHelper(_null, _null, $T._eval$1("InvokeHelper<Pointer<Pointer<0>>>")));
      t1 = $.$get$_knownTypes2();
      t1.$indexSet(0, A._rtiToString(A.createRuntimeType(t2)._rti, _null), new A.registerNativeMarshallerType_closure($T));
      t1.$indexSet(0, A._rtiToString(A.createRuntimeType(t3)._rti, _null), new A.registerNativeMarshallerType_closure0($T));
    },
    _toDartType(o, bind, $T) {
      if (A.createRuntimeType($T) === B.Type_int_tHn)
        if (A._isInt(o))
          return $T._as(o);
        else
          throw A.wrapException(A.MarshallingException$typeMissmatch(A.createRuntimeType($T), o));
      else if (A.createRuntimeType($T) === B.Type_double_K1J)
        if (typeof o == "number")
          return $T._as(o);
        else
          throw A.wrapException(A.MarshallingException$typeMissmatch(A.createRuntimeType($T), o));
      else if (A.createRuntimeType($T) === B.Type_bool_lhE)
        if (A._isBool(o))
          return $T._as(o);
        else if (A._isInt(o))
          return $T._as(o !== 0);
          ...
          throw A.wrapException(A.MarshallingException$typeMissmatch(A.createRuntimeType($T), o));
      else if (A.createRuntimeType($T) === $.$get$Pointer_Void())
        if (A._isInt(o))
          return $T._as(A.Pointer_Pointer$fromAddress(o, bind, type$.Void));
        else
          throw A.wrapException(A.MarshallingException$noAddress(o));
      else if (A.createRuntimeType($T) === $.$get$Pointer_IntPtr())
        if (A._isInt(o))
          return $T._as(A.Pointer_Pointer$fromAddress(o, bind, type$.IntPtr));
        else
          throw A.wrapException(A.MarshallingException$noAddress(o));
      else if (A.createRuntimeType($T) === $.$get$Pointer_UintPtr())
        if (A._isInt(o))
          return $T._as(A.Pointer_Pointer$fromAddress(o, bind, type$.UintPtr));
        else
          throw A.wrapException(A.MarshallingException$noAddress(o));
      else if (A.createRuntimeType($T) === $.$get$Pointer_Bool())
        if (A._isInt(o))
          return $T._as(A.Pointer_Pointer$fromAddress(o, bind, type$.Bool));
        else
          throw A.wrapException(A.MarshallingException$noAddress(o));
      else if (A.createRuntimeType($T) === $.$get$Pointer_Int())
        if (A._isInt(o))
          return $T._as(A.Pointer_Pointer$fromAddress(o, bind, type$.Int));
        else
          throw A.wrapException(A.MarshallingException$noAddress(o));
      else if (A.createRuntimeType($T) === $.$get$Pointer_Int8())
        if (A._isInt(o))
          return $T._as(A.Pointer_Pointer$fromAddress(o, bind, type$.Int8));
        else
          throw A.wrapException(A.MarshallingException$noAddress(o));
      else if (A.createRuntimeType($T) === $.$get$Pointer_Int16())
        if (A._isInt(o))
          return $T._as(A.Pointer_Pointer$fromAddress(o, bind, type$.Int16));
        else
          throw A.wrapException(A.MarshallingException$noAddress(o));
      else if (A.createRuntimeType($T) === $.$get$Pointer_Int32())
        if (A._isInt(o))
          return $T._as(A.Pointer_Pointer$fromAddress(o, bind, type$.Int32));
        else
          throw A.wrapException(A.MarshallingException$noAddress(o));
      else if (A.createRuntimeType($T) === $.$get$Pointer_Int64())
        if (A._isInt(o))
          return $T._as(A.Pointer_Pointer$fromAddress(o, bind, type$.Int64));
        else
          throw A.wrapException(A.MarshallingException$noAddress(o));
      else if (A.createRuntimeType($T) === $.$get$Pointer_Double())
        if (A._isInt(o))
          return $T._as(A.Pointer_Pointer$fromAddress(o, bind, type$.Double));
        else
          throw A.wrapException(A.MarshallingException$noAddress(o));
      else if (A.createRuntimeType($T) === $.$get$Pointer_UnsignedInt())
        if (A._isInt(o))
          return $T._as(A.Pointer_Pointer$fromAddress(o, bind, type$.UnsignedInt));
        else
          throw A.wrapException(A.MarshallingException$noAddress(o));
      else if (A.createRuntimeType($T) === $.$get$Pointer_Uint8())
        if (A._isInt(o))
          return $T._as(A.Pointer_Pointer$fromAddress(o, bind, type$.Uint8));
        else
          throw A.wrapException(A.MarshallingException$noAddress(o));
      else if (A.createRuntimeType($T) === $.$get$Pointer_Uint16())
        if (A._isInt(o))
          return $T._as(A.Pointer_Pointer$fromAddress(o, bind, type$.Uint16));
        else
          throw A.wrapException(A.MarshallingException$noAddress(o));
      else if (A.createRuntimeType($T) === $.$get$Pointer_Uint32())
        if (A._isInt(o))
          return $T._as(A.Pointer_Pointer$fromAddress(o, bind, type$.Uint32));
        else
          throw A.wrapException(A.MarshallingException$noAddress(o));
      else if (A.createRuntimeType($T) === $.$get$Pointer_Uint64())
        if (A._isInt(o))
          return $T._as(A.Pointer_Pointer$fromAddress(o, bind, type$.Uint64));
        else
          throw A.wrapException(A.MarshallingException$noAddress(o));
      else if (A.createRuntimeType($T) === $.$get$Pointer_Float())
        if (A._isInt(o))
          return $T._as(A.Pointer_Pointer$fromAddress(o, bind, type$.Float));
        else
          throw A.wrapException(A.MarshallingException$noAddress(o));
      else if (A.createRuntimeType($T) === $.$get$Pointer_Char())
        if (A._isInt(o))
          return $T._as(A.Pointer_Pointer$fromAddress(o, bind, type$.Char));
        else
          throw A.wrapException(A.MarshallingException$noAddress(o));
      else if (A.createRuntimeType($T) === $.$get$Pointer_Utf8())
        if (A._isInt(o))
          return $T._as(A.Pointer_Pointer$fromAddress(o, bind, type$.Utf8));
        else
          throw A.wrapException(A.MarshallingException$noAddress(o));
      else if (A.createRuntimeType($T) === $.$get$Pointer_Opaque())
        if (A._isInt(o))
          return $T._as(A.Pointer_Pointer$fromAddress(o, bind, type$.Opaque));
        else
          throw A.wrapException(A.MarshallingException$noAddress(o));
      else if (A.createRuntimeType($T) === $.$get$Pointer_NativeFunction_dynamic())
        if (A._isInt(o))
          return $T._as(A.Pointer_Pointer$fromAddress(o, bind, type$.NativeFunction_dynamic));
        else
          throw A.wrapException(A.MarshallingException$noAddress(o));
      else if (A.createRuntimeType($T) === $.$get$Pointer_Pointer_Void())
        if (A._isInt(o))
          return $T._as(A.Pointer_Pointer$fromAddress(o, bind, type$.Pointer_Void));
        else
          throw A.wrapException(A.MarshallingException$noAddress(o));
      else if (A.createRuntimeType($T) === $.$get$Pointer_Pointer_IntPtr())
        if (A._isInt(o))
          return $T._as(A.Pointer_Pointer$fromAddress(o, bind, type$.Pointer_IntPtr));
        else
          throw A.wrapException(A.MarshallingException$noAddress(o));
      else if (A.createRuntimeType($T) === $.$get$Pointer_Pointer_UintPtr())
        if (A._isInt(o))
          return $T._as(A.Pointer_Pointer$fromAddress(o, bind, type$.Pointer_UintPtr));
        else
          throw A.wrapException(A.MarshallingException$noAddress(o));
      else if (A.createRuntimeType($T) === $.$get$Pointer_Pointer_Bool())
        if (A._isInt(o))
          return $T._as(A.Pointer_Pointer$fromAddress(o, bind, type$.Pointer_Bool));
        else
          throw A.wrapException(A.MarshallingException$noAddress(o));
      else if (A.createRuntimeType($T) === $.$get$Pointer_Pointer_Int())
        if (A._isInt(o))
          return $T._as(A.Pointer_Pointer$fromAddress(o, bind, type$.Pointer_Int));
        else
          throw A.wrapException(A.MarshallingException$noAddress(o));
      else if (A.createRuntimeType($T) === $.$get$Pointer_Pointer_Int8())
        if (A._isInt(o))
          return $T._as(A.Pointer_Pointer$fromAddress(o, bind, type$.Pointer_Int8));
        else
          throw A.wrapException(A.MarshallingException$noAddress(o));
      else if (A.createRuntimeType($T) === $.$get$Pointer_Pointer_Int16())
        if (A._isInt(o))
          return $T._as(A.Pointer_Pointer$fromAddress(o, bind, type$.Pointer_Int16));
        else
          throw A.wrapException(A.MarshallingException$noAddress(o));
      else if (A.createRuntimeType($T) === $.$get$Pointer_Pointer_Int32())
        if (A._isInt(o))
          return $T._as(A.Pointer_Pointer$fromAddress(o, bind, type$.Pointer_Int32));
        else
          throw A.wrapException(A.MarshallingException$noAddress(o));
      else if (A.createRuntimeType($T) === $.$get$Pointer_Pointer_Int64())
        if (A._isInt(o))
          return $T._as(A.Pointer_Pointer$fromAddress(o, bind, type$.Pointer_Int64));
        else
          throw A.wrapException(A.MarshallingException$noAddress(o));
      else if (A.createRuntimeType($T) === $.$get$Pointer_Pointer_Double())
        if (A._isInt(o))
          return $T._as(A.Pointer_Pointer$fromAddress(o, bind, type$.Pointer_Double));
        else
          throw A.wrapException(A.MarshallingException$noAddress(o));
      else if (A.createRuntimeType($T) === $.$get$Pointer_Pointer_UnsignedInt())
        if (A._isInt(o))
          return $T._as(A.Pointer_Pointer$fromAddress(o, bind, type$.Pointer_UnsignedInt));
        else
          throw A.wrapException(A.MarshallingException$noAddress(o));
      else if (A.createRuntimeType($T) === $.$get$Pointer_Pointer_Uint8())
        if (A._isInt(o))
          return $T._as(A.Pointer_Pointer$fromAddress(o, bind, type$.Pointer_Uint8));
        else
          throw A.wrapException(A.MarshallingException$noAddress(o));
      else if (A.createRuntimeType($T) === $.$get$Pointer_Pointer_Uint16())
        if (A._isInt(o))
          return $T._as(A.Pointer_Pointer$fromAddress(o, bind, type$.Pointer_Uint16));
        else
          throw A.wrapException(A.MarshallingException$noAddress(o));
      else if (A.createRuntimeType($T) === $.$get$Pointer_Pointer_Uint32())
        if (A._isInt(o))
          return $T._as(A.Pointer_Pointer$fromAddress(o, bind, type$.Pointer_Uint32));
        else
          throw A.wrapException(A.MarshallingException$noAddress(o));
      else if (A.createRuntimeType($T) === $.$get$Pointer_Pointer_Uint64())
        if (A._isInt(o))
          return $T._as(A.Pointer_Pointer$fromAddress(o, bind, type$.Pointer_Uint64));
        else
          throw A.wrapException(A.MarshallingException$noAddress(o));
      else if (A.createRuntimeType($T) === $.$get$Pointer_Pointer_Char())
        if (A._isInt(o))
          return $T._as(A.Pointer_Pointer$fromAddress(o, bind, type$.Pointer_Char));
        else
          throw A.wrapException(A.MarshallingException$noAddress(o));
      else if (A.createRuntimeType($T) === $.$get$Pointer_Pointer_Utf8())
        if (A._isInt(o))
          return $T._as(A.Pointer_Pointer$fromAddress(o, bind, type$.Pointer_Utf8));
        else
          throw A.wrapException(A.MarshallingException$noAddress(o));
      else if (A.createRuntimeType($T) === $.$get$Pointer_Pointer_Float())
        if (A._isInt(o))
          return $T._as(A.Pointer_Pointer$fromAddress(o, bind, type$.Pointer_Float));
        else
          throw A.wrapException(A.MarshallingException$noAddress(o));
      else if (A.createRuntimeType($T) === $.$get$Pointer_Pointer_Opaque())
        if (A._isInt(o))
          return $T._as(A.Pointer_Pointer$fromAddress(o, bind, type$.Pointer_Opaque));
        else
          throw A.wrapException(A.MarshallingException$noAddress(o));
      else
        throw A.wrapException(A.MarshallingException$("Can not back-marshall to type " + A.createRuntimeType($T).toString$0(0) + " (object type is " + J.get$runtimeType$(o).toString$0(0) + ")"));
    },
    _knownTypes2_closure: function _knownTypes2_closure() {
    },
    _knownTypes2_closure0: function _knownTypes2_closure0() {
    },
    _knownTypes2_closure1: function _knownTypes2_closure1() {
    },
    _knownTypes2_closure2: function _knownTypes2_closure2() {
    },
    registerNativeMarshallerType_closure: function registerNativeMarshallerType_closure(t0) {
      this.T = t0;
    },
    registerNativeMarshallerType_closure0: function registerNativeMarshallerType_closure0(t0) {
      this.T = t0;
    },
    sizeOf($T) {
      var size = B.JSString_methods.startsWith$1(A._rtiToString(A.createRuntimeType($T)._rti, null), $.$get$_pointerPrefix()) ? $.sizeMap.$index(0, B.Type_IntPtr_Y0S) : $.sizeMap.$index(0, A.createRuntimeType($T));
      if (size != null)
        return size;
      else
        throw A.wrapException(A.ArgumentError$("The type " + A.createRuntimeType($T).toString$0(0) + " is not known!", null));
    },
    Pointer_Pointer$fromAddress(ptr, bindTo, $T) {
      var t1 = B.JSString_methods.startsWith$1(A._rtiToString(A.createRuntimeType($T)._rti, null), $.$get$_nativeFunctionPrefix()) || A.createRuntimeType($T) === $.$get$FfiVoidType() ? null : A.sizeOf($T);
      return new A.Pointer(ptr, bindTo, t1, $T._eval$1("Pointer<0>"));
    },
    ...
    FunctionsAndGlobals: function FunctionsAndGlobals(t0) {
    ...
    _MemoryDescriptor: function _MemoryDescriptor() {
    },
    _TableDescriptor: function _TableDescriptor() {
    },
    _GlobalDescriptor: function _GlobalDescriptor() {
    },
    _WebAssemblyInstantiatedSource: function _WebAssemblyInstantiatedSource() {
    },
    _Module: function _Module() {
    },
    _Instance: function _Instance() {
    },
    _Memory: function _Memory() {
    },
    ...
    NativeFunctionPointer_asFunction(_this, NF, DF) {
      var t1 = _this.boundMemory,
        t2 = _this.address,
        symbol = A.symbolByAddress(t1, t2);
      if (symbol instanceof A.FunctionDescription)
        return DF._as(new A.InvokeHelper(t1, symbol.$function, A._inferFromSignature(A._rtiToString(A.createRuntimeType(DF)._rti, null)).$ti).get$run());
      else
        throw A.wrapException(A.ArgumentError$("No function at address " + t2 + " was found (but a global symbol)!", null));
    },
    typeString($T) {
      return A._rtiToString(A.createRuntimeType($T)._rti, null);
    },
    fromCString(cString) {
      var len, t1, t2;
      for (len = 0; cString.viewSingle$1(len).getUint8(0) !== 0;)
        ++len;
      if (len > 0) {
        t1 = cString.boundMemory._module.get$heap();
        t2 = cString.address;
        A._checkViewArguments(t1, t2, len);
        t1 = new Uint8Array(t1, t2, len);
        t1 = B.C_AsciiCodec.decode$1(0, t1);
      } else
        t1 = "";
      return t1;
    },
    initFfi() {
      var $async$goto = 0,
        ...
        $async$temp1;
      var $async$initFfi = A._wrapJsFunctionForAsync(function($async$errorCode, $async$result) {
        if ($async$errorCode === 1)
          return A._asyncRethrow($async$result, $async$completer);
        while (true)
          switch ($async$goto) {
            case 0:
              // Function start
              $async$goto = $._library == null ? 2 : 3;
              break;
            case 2:
              // then
              $async$temp1 = $;
              $async$goto = 4;
              return A._asyncAwait(A.DynamicLibrary_open(B.WasmType_1, "libopus"), $async$initFfi);
            case 4:
              // returning from await.
              $async$temp1._library = $async$result;
            case 3:
              // join
              // implicit return
      ...
      return A._asyncStartSync($async$initFfi, $async$completer);
    },
    openOpus() {
      var t1 = $._library;
      if (t1 != null)
        ...
        throw A.wrapException(A.StateError$("You can not open opus before calling initFfi()!"));
    },
    main() {
      var $async$goto = 0,
        $async$completer = A._makeAsyncAwaitCompleter(type$.void),
        ...
        while (true)
          switch ($async$goto) {
            case 0:
              // Function start
              $async$goto = 2;
              return A._asyncAwait(A.initFfi(), $async$main);
            case 2:
              // returning from await.
              t1 = type$.Pointer_Uint8_Function;
              A.printString(A.fromCString(A.NativeFunctionPointer_asFunction(A.openOpus().lookup$1$1("opus_get_version_string", type$.NativeFunction_of_Pointer_Uint8_Function), t1, t1).call$0()));
              // implicit return
              return A._asyncReturn(null, $async$completer);
          }
      });
  ...
  A.MapBase.prototype = {
    ...
    addEntries$1(receiver, newEntries) {
      ...
      for (t1 = newEntries.$ti, t2 = new A.ListIterator(newEntries, newEntries.get$length(newEntries), t1._eval$1("ListIterator<ListIterable.E>")), t1 = t1._eval$1("ListIterable.E"); t2.moveNext$0();) {
      ...
      for (i = 0; i < end; ++i) {
        ...
        if ((byte & 4294967168) !== 0) {
          if (!this._allowInvalid)
            throw A.wrapException(new A.FormatException("Invalid value in input: " + byte));
  ...
  A.WasmType.prototype = {
    _enumToString$0() {
      return "WasmType." + this._core$_name;
    }
  };
  A.DynamicLibrary.prototype = {
    lookup$1$1($name, $T) {
      var t1, symbol;
      A.checkTypeBound($T, type$.NativeType, "T", "lookup");
      t1 = this.boundMemory;
      symbol = A.symbolByName(t1, $name);
      if (B.JSString_methods.startsWith$1(A._rtiToString(A.createRuntimeType($T)._rti, null), $.$get$_nativeFunctionPrefix()))
        if (symbol instanceof A.FunctionDescription)
          return A.Pointer_Pointer$fromAddress(symbol.address, t1, $T);
        else
          throw A.wrapException(A.ArgumentError$("Tried to look up " + $name + " as a function, but it seems it is NOT a function!", null));
      else
        return A.Pointer_Pointer$fromAddress(symbol.address, t1, $T);
    }
  };
  A.Memory.prototype = {};
  A.Memory$__closure.prototype = {
    call$1(symbol) {
      type$.WasmSymbol._as(symbol);
      return new A.MapEntry(symbol.address, symbol, type$.MapEntry_int_WasmSymbol);
    },
    $signature: 17
  };
  A.Memory$__closure0.prototype = {
    call$1(symbol) {
      type$.WasmSymbol._as(symbol);
      return new A.MapEntry(symbol.name, symbol, type$.MapEntry_String_WasmSymbol);
    },
    $signature: 18
  };
  A.GlobalMemory.prototype = {
    _enumToString$0() {
      return "GlobalMemory." + this._core$_name;
    }
  };
  A._EmscriptenModuleJs.prototype = {};
  A.EmscriptenModule.prototype = {
    get$exports(_) {
      return this._exports;
    },
    get$heap() {
      return this._getHeap$0();
    },
    _getHeap$0() {
      ...
      if (h != null)
        ...
        throw A.wrapException(A.StateError$("Unexpected memory error!"));
    }
  };
  A.MarshallingException.prototype = {
    toString$0(_) {
      return new A._Exception(this.message).toString$0(0);
    }
  };
  A.Module.prototype = {};
  A.WasmSymbol.prototype = {
    get$hashCode(_) {
  ...
  A.Global.prototype = {
    $eq(_, other) {
      if (other == null)
        return false;
      if (other instanceof A.Global)
        return this.name === other.name && this.address === other.address;
      else
        return false;
    }
  };
  A.FunctionDescription.prototype = {
    get$hashCode(_) {
      return B.JSString_methods.get$hashCode(this.name + this.argumentCount + this.address);
    },
    $eq(_, other) {
      if (other == null)
        return false;
      if (other instanceof A.FunctionDescription)
    ...
    toString$0(_) {
      var _this = this;
      return "[tableIndex=" + _this.address + "\tname=" + _this.name + "\targumentCount=" + _this.argumentCount + "\tfunction=" + A.S(_this.$function) + "]";
    }
  };
  A.InvokeHelper.prototype = {
    run$127(arg0, arg1, arg2, arg3, arg4, arg5, arg6, arg7, arg8, arg9, arg10, arg11, arg12, arg13, arg14, arg15, arg16, arg17, arg18, arg19, arg20, arg21, arg22, arg23, arg24, arg25, arg26, arg27, arg28, arg29, arg30, arg31, arg32, arg33, arg34, arg35, arg36, arg37, arg38, arg39, arg40, arg41, arg42, arg43, arg44, arg45, arg46, arg47, arg48, arg49, arg50, arg51, arg52, arg53, arg54, arg55, arg56, arg57, arg58, arg59, arg60, arg61, arg62, arg63, arg64, arg65, arg66, arg67, arg68, arg69, arg70, arg71, arg72, arg73, arg74, arg75, arg76, arg77, arg78, arg79, arg80, arg81, arg82, arg83, arg84, arg85, arg86, arg87, arg88, arg89, arg90, arg91, arg92, arg93, arg94, arg95, arg96, arg97, arg98, arg99, arg100, arg101, arg102, arg103, arg104, arg105, arg106, arg107, arg108, arg109, arg110, arg111, arg112, arg113, arg114, arg115, arg116, arg117, arg118, arg119, arg120, arg121, arg122, arg123, arg124, arg125, arg126) {
      ...
      if (t1 == null || _this._memory == null)
        throw A.wrapException(A.StateError$("Call copyWith first!"));
      t1.toString;
      t2 = _this._memory;
      t2.toString;
      args = A._setArrayType([], type$.JSArray_Object);
      return A.execute(t1, args, t2, _this.$ti._precomputed1);
    },
    run$0() {
  ...
  A._knownTypes2_closure.prototype = {
    call$2(o, b) {
      return A._toDartType(o, b, type$.int);
    },
    $signature: 19
  };
  A._knownTypes2_closure0.prototype = {
    call$2(o, b) {
      return A._toDartType(o, b, type$.double);
    },
    $signature: 20
  };
  A._knownTypes2_closure1.prototype = {
    call$2(o, b) {
      return A._toDartType(o, b, type$.bool);
    },
    $signature: 21
  };
  A._knownTypes2_closure2.prototype = {
    call$2(o, b) {
      return A._toDartType(o, b, type$.void);
    },
    $signature: 22
  };
  A.registerNativeMarshallerType_closure.prototype = {
    call$2(o, b) {
      var t1 = o == null ? type$.Object._as(o) : o;
      return A._toDartType(t1, type$.Memory._as(b), this.T._eval$1("Pointer<0>"));
    },
    $signature() {
      return this.T._eval$1("Pointer<0>(@,@)");
    }
  };
  A.registerNativeMarshallerType_closure0.prototype = {
    call$2(o, b) {
      var t1 = o == null ? type$.Object._as(o) : o;
      return A._toDartType(t1, type$.Memory._as(b), this.T._eval$1("Pointer<Pointer<0>>"));
    },
    $signature() {
      return this.T._eval$1("Pointer<Pointer<0>>(@,@)");
    }
  };
  A.NativeType.prototype = {};
  A.Pointer.prototype = {
    get$hashCode(_) {
      return this.address;
    },
    $eq(_, other) {
      if (other == null)
        return false;
      return other instanceof A.Pointer && other.address === this.address;
    },
    viewSingle$1(index) {
      var t1, t2,
        s = this.size;
      if (s != null) {
        t1 = this.boundMemory._module.get$heap();
        t2 = this.address + index * s;
        A._checkViewArguments(t1, t2, s);
        t1 = new DataView(t1, t2, s);
        return t1;
      } else
        throw A.wrapException(A.UnsupportedError$("viewSingle is not supported for unsized types!"));
    }
  };
  A.FunctionsAndGlobals.prototype = {};
  A.ModuleImportDescriptor.prototype = {};
  A.ModuleExportDescriptor.prototype = {};
  A._MemoryDescriptor.prototype = {};
  A._TableDescriptor.prototype = {};
  A._GlobalDescriptor.prototype = {};
  A._WebAssemblyInstantiatedSource.prototype = {};
  A._Module.prototype = {};
  A._Instance.prototype = {};
  A._Memory.prototype = {};
  A._Table.prototype = {};
  A._Global.prototype = {};
  (function aliases() {
  ...
  (function installTearOffs() {
    ...
    _instance(A.InvokeHelper.prototype, "get$run", 0, 0, null, ["call$127", "call$0", "call$2", "call$1", "call$3", "call$4"], ["run$127", "run$0", "run$2", "run$1", "run$3", "run$4"], "1([@,@,@,@,@,@,@,@,@,@,@,@,@,@,@,@,@,@,@,@,@,@,@,@,@,@,@,@,@,@,@,@,@,@,@,@,@,@,@,@,@,@,@,@,@,@,@,@,@,@,@,@,@,@,@,@,@,@,@,@,@,@,@,@,@,@,@,@,@,@,@,@,@,@,@,@,@,@,@,@,@,@,@,@,@,@,@,@,@,@,@,@,@,@,@,@,@,@,@,@,@,@,@,@,@,@,@,@,@,@,@,@,@,@,@,@,@,@,@,@,@,@,@,@,@,@,@])", 0, 0);
    _static_1(A, "marshaller___toJsType$closure", "_toJsType", 23);
  })();
  (function inheritance() {
    ...
    _inheritMany(J.LegacyJavaScriptObject, [J.PlainJavaScriptObject, J.UnknownJavaScriptObject, J.JavaScriptFunction, A._EmscriptenModuleJs, A.ModuleImportDescriptor, A.ModuleExportDescriptor, A._MemoryDescriptor, A._TableDescriptor, A._GlobalDescriptor, A._WebAssemblyInstantiatedSource, A._Module, A._Instance, A._Memory, A._Table, A._Global]);
    ...
    _inherit(A._UnicodeSubsetDecoder, A.Converter);
    ...
    _inheritMany(A._Enum, [A.WasmType, A.GlobalMemory]);
    _inherit(A.EmscriptenModule, A.Module);
    _inheritMany(A.WasmSymbol, [A.Global, A.FunctionDescription]);
    _inherit(A.Pointer, A.NativeType);
  ...
  var type$ = (function rtii() {
    ...
    return {
      ...
      DynamicLibrary: findType("DynamicLibrary"),
      ...
      Pointer_Bool: findType("Pointer<Bool>"),
      Pointer_Char: findType("Pointer<Char>"),
      Pointer_Double: findType("Pointer<Double>"),
      Pointer_Float: findType("Pointer<Float>"),
      Pointer_Int: findType("Pointer<Int>"),
      ...
      Pointer_UintPtr: findType("Pointer<UintPtr>"),
      Pointer_UnsignedInt: findType("Pointer<UnsignedInt>"),
      Pointer_Utf8: findType("Pointer<Utf8>"),
      ...
      UintPtr: findType("UintPtr"),
      UnknownJavaScriptObject: findType("UnknownJavaScriptObject"),
      UnsignedInt: findType("UnsignedInt"),
      Utf8: findType("Utf8"),
      Void: findType("Void"),
...
;
    ...
    B.GlobalMemory_0 = new A.GlobalMemory("yes");
    B.GlobalMemory_1 = new A.GlobalMemory("no");
    B.GlobalMemory_2 = new A.GlobalMemory("ifNotSet");
    B.InvokeHelper_null_null1 = new A.InvokeHelper(null, null, A.findType("InvokeHelper<bool>"));
    B.InvokeHelper_null_null0 = new A.InvokeHelper(null, null, A.findType("InvokeHelper<double>"));
    B.InvokeHelper_null_null = new A.InvokeHelper(null, null, A.findType("InvokeHelper<int>"));
    B.InvokeHelper_null_null2 = new A.InvokeHelper(null, null, A.findType("InvokeHelper<~>"));
    ...
    B.MarshallingException_CC0 = new A.MarshallingException("Nesting pointers is only supported to a deepth of 2!\nThis means that you can write Pointer<Pointer<X>> but not Pointer<Pointer<Pointer<X>>>, ...");
    B.MarshallingException_VRH = new A.MarshallingException("Using pointers to native functions as return type is only allowed if the type of the native function is dynamic!\nThis means that only Pointer<NativeFunction<dynamic>> is allowed!");
    ...
    B.Type_IntPtr_Y0S = A.typeLiteral("IntPtr");
    ...
    B.WasmType_1 = new A.WasmType("withJs");
  })();
  (function staticFields() {
    ...
    $.sizeMap = A.LinkedHashMap_LinkedHashMap$_empty(A.findType("Type"), type$.int);
    $.Memory__initalized = false;
    $.Memory_global = null;
    $._library = null;
  })();
  (function lazyInitializers() {
    ...
    _lazyFinal($, "_knownTypes", "$get$_knownTypes", () => A.LinkedHashMap_LinkedHashMap$_literal([A.typeString(type$.int), B.InvokeHelper_null_null, A.typeString(type$.double), B.InvokeHelper_null_null0, A.typeString(type$.bool), B.InvokeHelper_null_null1, A.typeString(type$.void), B.InvokeHelper_null_null2], type$.String, A.findType("InvokeHelper<@>")));
    _lazyFinal($, "_knownTypes2", "$get$_knownTypes2", () => A.LinkedHashMap_LinkedHashMap$_literal([A.typeString(type$.int), new A._knownTypes2_closure(), A.typeString(type$.double), new A._knownTypes2_closure0(), A.typeString(type$.bool), new A._knownTypes2_closure1(), A.typeString(type$.void), new A._knownTypes2_closure2()], type$.String, type$.Function));
    _lazyFinal($, "Pointer_IntPtr", "$get$Pointer_IntPtr", () => A.createRuntimeType(type$.Pointer_IntPtr));
    _lazyFinal($, "Pointer_UintPtr", "$get$Pointer_UintPtr", () => A.createRuntimeType(type$.Pointer_UintPtr));
    _lazyFinal($, "Pointer_Void", "$get$Pointer_Void", () => A.createRuntimeType(type$.Pointer_Void));
    _lazyFinal($, "Pointer_Bool", "$get$Pointer_Bool", () => A.createRuntimeType(type$.Pointer_Bool));
    _lazyFinal($, "Pointer_Int", "$get$Pointer_Int", () => A.createRuntimeType(type$.Pointer_Int));
    _lazyFinal($, "Pointer_Int8", "$get$Pointer_Int8", () => A.createRuntimeType(type$.Pointer_Int8));
    _lazyFinal($, "Pointer_Int16", "$get$Pointer_Int16", () => A.createRuntimeType(type$.Pointer_Int16));
    _lazyFinal($, "Pointer_Int32", "$get$Pointer_Int32", () => A.createRuntimeType(type$.Pointer_Int32));
    _lazyFinal($, "Pointer_Int64", "$get$Pointer_Int64", () => A.createRuntimeType(type$.Pointer_Int64));
    _lazyFinal($, "Pointer_Double", "$get$Pointer_Double", () => A.createRuntimeType(type$.Pointer_Double));
    _lazyFinal($, "Pointer_UnsignedInt", "$get$Pointer_UnsignedInt", () => A.createRuntimeType(type$.Pointer_UnsignedInt));
    _lazyFinal($, "Pointer_Uint8", "$get$Pointer_Uint8", () => A.createRuntimeType(type$.Pointer_Uint8));
    _lazyFinal($, "Pointer_Uint16", "$get$Pointer_Uint16", () => A.createRuntimeType(type$.Pointer_Uint16));
    _lazyFinal($, "Pointer_Uint32", "$get$Pointer_Uint32", () => A.createRuntimeType(type$.Pointer_Uint32));
    _lazyFinal($, "Pointer_Uint64", "$get$Pointer_Uint64", () => A.createRuntimeType(type$.Pointer_Uint64));
    _lazyFinal($, "Pointer_Char", "$get$Pointer_Char", () => A.createRuntimeType(type$.Pointer_Char));
    _lazyFinal($, "Pointer_Utf8", "$get$Pointer_Utf8", () => A.createRuntimeType(type$.Pointer_Utf8));
    _lazyFinal($, "Pointer_Float", "$get$Pointer_Float", () => A.createRuntimeType(type$.Pointer_Float));
    _lazyFinal($, "Pointer_Opaque", "$get$Pointer_Opaque", () => A.createRuntimeType(type$.Pointer_Opaque));
    _lazyFinal($, "Pointer_Pointer_IntPtr", "$get$Pointer_Pointer_IntPtr", () => A.createRuntimeType(A.findType("Pointer<Pointer<IntPtr>>")));
    _lazyFinal($, "Pointer_Pointer_UintPtr", "$get$Pointer_Pointer_UintPtr", () => A.createRuntimeType(A.findType("Pointer<Pointer<UintPtr>>")));
    _lazyFinal($, "Pointer_Pointer_Void", "$get$Pointer_Pointer_Void", () => A.createRuntimeType(A.findType("Pointer<Pointer<Void>>")));
    _lazyFinal($, "Pointer_Pointer_Bool", "$get$Pointer_Pointer_Bool", () => A.createRuntimeType(A.findType("Pointer<Pointer<Bool>>")));
    _lazyFinal($, "Pointer_Pointer_Int", "$get$Pointer_Pointer_Int", () => A.createRuntimeType(A.findType("Pointer<Pointer<Int>>")));
    _lazyFinal($, "Pointer_Pointer_Int8", "$get$Pointer_Pointer_Int8", () => A.createRuntimeType(A.findType("Pointer<Pointer<Int8>>")));
    _lazyFinal($, "Pointer_Pointer_Int16", "$get$Pointer_Pointer_Int16", () => A.createRuntimeType(A.findType("Pointer<Pointer<Int16>>")));
    _lazyFinal($, "Pointer_Pointer_Int32", "$get$Pointer_Pointer_Int32", () => A.createRuntimeType(A.findType("Pointer<Pointer<Int32>>")));
    _lazyFinal($, "Pointer_Pointer_Int64", "$get$Pointer_Pointer_Int64", () => A.createRuntimeType(A.findType("Pointer<Pointer<Int64>>")));
    _lazyFinal($, "Pointer_Pointer_Double", "$get$Pointer_Pointer_Double", () => A.createRuntimeType(A.findType("Pointer<Pointer<Double>>")));
    _lazyFinal($, "Pointer_Pointer_UnsignedInt", "$get$Pointer_Pointer_UnsignedInt", () => A.createRuntimeType(A.findType("Pointer<Pointer<UnsignedInt>>")));
    _lazyFinal($, "Pointer_Pointer_Uint8", "$get$Pointer_Pointer_Uint8", () => A.createRuntimeType(A.findType("Pointer<Pointer<Uint8>>")));
    _lazyFinal($, "Pointer_Pointer_Uint16", "$get$Pointer_Pointer_Uint16", () => A.createRuntimeType(A.findType("Pointer<Pointer<Uint16>>")));
    _lazyFinal($, "Pointer_Pointer_Uint32", "$get$Pointer_Pointer_Uint32", () => A.createRuntimeType(A.findType("Pointer<Pointer<Uint32>>")));
    _lazyFinal($, "Pointer_Pointer_Uint64", "$get$Pointer_Pointer_Uint64", () => A.createRuntimeType(A.findType("Pointer<Pointer<Uint64>>")));
    _lazyFinal($, "Pointer_Pointer_Char", "$get$Pointer_Pointer_Char", () => A.createRuntimeType(A.findType("Pointer<Pointer<Char>>")));
    _lazyFinal($, "Pointer_Pointer_Utf8", "$get$Pointer_Pointer_Utf8", () => A.createRuntimeType(A.findType("Pointer<Pointer<Utf8>>")));
    _lazyFinal($, "Pointer_Pointer_Float", "$get$Pointer_Pointer_Float", () => A.createRuntimeType(A.findType("Pointer<Pointer<Float>>")));
    _lazyFinal($, "Pointer_Pointer_Opaque", "$get$Pointer_Pointer_Opaque", () => A.createRuntimeType(A.findType("Pointer<Pointer<Opaque>>")));
    _lazyFinal($, "Pointer_NativeFunction_dynamic", "$get$Pointer_NativeFunction_dynamic", () => A.createRuntimeType(A.findType("Pointer<NativeFunction<@>>")));
    _lazyFinal($, "DartVoidType", "$get$DartVoidType", () => A.createRuntimeType(type$.void));
    _lazyFinal($, "FfiVoidType", "$get$FfiVoidType", () => A.createRuntimeType(type$.Void));
    _lazyFinal($, "_dynamicTypeString", "$get$_dynamicTypeString", () => A.typeString(type$.dynamic));
    _lazyFinal($, "pointerPointerPointerPrefix", "$get$pointerPointerPointerPrefix", () => B.JSArray_methods.get$first(A.typeString(A.findType("Pointer<Pointer<Pointer<@>>>")).split($.$get$_dynamicTypeString())));
    _lazyFinal($, "pointerNativeFunctionPrefix", "$get$pointerNativeFunctionPrefix", () => B.JSArray_methods.get$first(A.typeString(A.findType("Pointer<NativeFunction<@>>")).split($.$get$_dynamicTypeString())));
    _lazyFinal($, "_nativeFunctionPrefix", "$get$_nativeFunctionPrefix", () => B.JSArray_methods.get$first(A.typeString(type$.NativeFunction_dynamic).split($.$get$_dynamicTypeString())));
    _lazyFinal($, "_pointerPrefix", "$get$_pointerPrefix", () => B.JSArray_methods.get$first(A.typeString(A.findType("Pointer<@>")).split($.$get$_dynamicTypeString())));
  })();
